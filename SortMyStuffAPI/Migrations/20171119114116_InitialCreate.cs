        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ConcurrencyStamp = table.Column<string>(nullable: true),
                    CreateTimestamp = table.Column<DateTimeOffset>(nullable: false),
                    ...
                    RootAssetContractId = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreateTimestamp = table.Column<DateTimeOffset>(nullable: false),
                    ModifyTimestamp = table.Column<DateTimeOffset>(nullable: false),
                    Name = table.Column<string>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BaseDetails", x => x.Id)
                        .Annotation("SqlServer:Clustered", false);
                    table.ForeignKey(
                        name: "FK_BaseDetails_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BaseDetails_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BaseId = table.Column<string>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Details", x => x.Id)
                        .Annotation("SqlServer:Clustered", false);
                    table.ForeignKey(
                        name: "FK_Details_Assets_AssetId",
                        column: x => x.AssetId,
                        principalTable: "Assets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Details_BaseDetails_BaseId",
                        column: x => x.BaseId,
                        principalTable: "BaseDetails",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BaseDetails_CategoryId",
                table: "BaseDetails",
                column: "CategoryId")
                .Annotation("SqlServer:Clustered", true);

            migrationBuilder.CreateIndex(
                name: "IX_BaseDetails_UserId",
                table: "BaseDetails",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Details_AssetId",
                table: "Details",
                column: "AssetId");

            migrationBuilder.CreateIndex(
                name: "IX_Details_BaseId",
                table: "Details",
                column: "BaseId")
                .Annotation("SqlServer:Clustered", true);
